...
#     |> IO.inspect(label: "cpu count")
#     System.get_env()
#     |> Enum.to_list()
#     |> Enum.map(fn {key, vl} -> "#{key} === #{vl}\n"  end)
#     |> write_stream_to_csv("./sys_args_powershell.txt", use_headers: false)
